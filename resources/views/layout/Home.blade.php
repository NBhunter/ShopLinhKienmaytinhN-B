...
<body>
  ...
  <div id="top-header">
         ...
         <li><button type="button" class="btn btn-danger"> <img src="./image/giohang.png" alt="" width="24" height="24" class="d-inline-block align-text-top ml-auto">Giỏ Hàng</button></li>
   <li><button type="button" class="btn btn-danger"> <img src="./image/iconuser.png" alt="" width="24" height="24" class="d-inline-block align-text-top ml-auto">Đăng Nhập</button></li>
